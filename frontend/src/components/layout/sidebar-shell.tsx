...
const NAV: Array<NavItem> = [
  ...
  { to: "/arbeitsschutz", label: "Arbeitsschutz", icon: HardHat, group: "compliance" },
  {
    to: "/fragebogen",
    label: "OEM-Fragebögen",
    icon: ClipboardList,
    group: "compliance",
  },
  {
    to: "/antwort-bibliothek",
    label: "Antwort-Bibliothek",
    icon: Library,
    group: "compliance",
  },
  { to: "/audit", label: "Audit-Log", icon: FileSearch, group: "compliance" },
  { to: "/audit-export", label: "Audit-Export", icon: ClipboardCheck, group: "compliance" },
