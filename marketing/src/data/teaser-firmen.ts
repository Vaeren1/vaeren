...
export const FIRMS: TeaserFirma[] = [
  {
    ...
    vals: [1, 2, 0, 2, 2, 4],
    module: {
      Governance: [["Interne Meldestelle (HinSchG)", "§§ 12 ff. HinSchG"], ["Transparenzregister", "§ 20 GwG"], ["Geschäftsgeheimnis-Schutz", "GeschGehG"], ["Lieferketten-Sorgfalt", "LkSG, via OEM"]],
  ...
  },
  {
    ...
    vals: [1, 2, 2, 2, 0, 3],
    module: {
      Governance: [["Interne Meldestelle (HinSchG)", "§§ 12 ff. HinSchG"], ["Transparenzregister", "§ 20 GwG"], ["Geschäftsgeheimnis-Schutz", "GeschGehG"]],
      "IT-Sicherheit": [["NIS2-Risikomanagement", "NIS2UmsuCG"], ["Cyber-Produktsicherheit", "VO (EU) 2024/2847"]],
      KI: [["KI-Inventar (EU AI Act)", "VO (EU) 2024/1689"], ["ISO 42001 KI-Management", "ISO/IEC 42001"]],
  ...
  },
  {
    ...
    vals: [1, 1, 0, 2, 0, 4],
    module: {
      Governance: [["Interne Meldestelle (HinSchG)", "§§ 12 ff. HinSchG"], ["Transparenzregister", "§ 20 GwG"], ["Geschäftsgeheimnis-Schutz", "GeschGehG"], ["CSRD-Nachhaltigkeitsbericht", "ab 250 MA"]],
